a <- rfp(2021,10)
am <- strsplit(a, "") # List of single character vectors
...
# Part 1
sum(errs) # Sum of errors found

# Part 2
red <- \(x,y) x*5+y # Reduce function
sapply(Filter(Negate(is.null), comps), Reduce, f=red) |> median() # Compute all metrics with reduce and take median
# 16.7 miliseconds
